...
<aside class="bg-primary text-white p-3 d-flex flex-column" style="width: 260px; min-height: 100vh;">
    <h2 class="text-center mb-4">Menú de Administrador</h2>
    <nav class="nav flex-column">
        <a href="dashboard_admin.php" class="nav-link text-white fw-semibold d-flex align-items-center gap-2 mb-2">
            <i class="bi bi-house-door-fill fs-5"></i> <span>Inicio</span>
        </a>
        
        <a href="reports_admin.php" class="nav-link text-white fw-semibold d-flex align-items-center gap-2 active rounded mb-2">
...
<main class="flex-grow-1 p-4">
    ...
    <div class="bg-white p-4 rounded shadow border-start border-custom border-5">
        ...
        <p class="text-muted">Todos los reportes del sistema</p>
                ...
                <tbody>
                    <?php foreach ($reports as $report): ?>
                        <tr>
                            ...
                            <td>
                                <form method="POST" action="reports_admin.php" class="d-inline" id="form-delete-<?= $report['id_report'] ?>">
