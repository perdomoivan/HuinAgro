...
<head>
    <meta charset="UTF-8">
    <title>Historial de Ventas - Usuario</title>
    <!-- SweetAlert2 -->
...
<body>
    <div class="sidebar">
        <h3>HuinAgro</h3>
        <nav>
            <a href="dashboard_coordinator.php" data-icon="🏠">Inicio</a>
            <a href="fishing_records.php" data-icon="📋">Registrar Venta</a>
            <a href="user_history.php" data-icon="📜" class="active">Historial</a>
        </nav>
            ...
            <?php foreach ($grouped as $id_record => $data): ?>
                <div class="record">
                    <div class="record-header">
                        ...
                        - Coordinador: <?= htmlspecialchars($data['info']['username'] ?? 'Sin coordinador') ?>
                    </div>
                    <table>
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            <?php foreach ($data['entries'] as $entry): ?>
                                <tr>
                                    ...
                                    <td><?= htmlspecialchars(number_format($entry['gross_weight'], 1)) ?></td>
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <td><strong><?= htmlspecialchars($data['totals']['baskets']) ?></strong></td>
                                <td><strong><?= htmlspecialchars(number_format($data['totals']['gross_weight'], 1)) ?></strong></td>
                                <td></td>
                                <td><strong><?= htmlspecialchars(number_format($data['totals']['total_value'], 3)) ?></strong></td>
                            </tr>
                        </tfoot>
                    </table>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?= htmlspecialchars(number_format($tot['gross_weight'], 1)) ?></td>
                    ...
                    <div class="record-buttons">
                        <form action="editar_registro.php" method="get" class="edit-form">
    ...
    <script>
        ...
        document.querySelectorAll('.edit-form').forEach(form => {
            form.addEventListener('submit', function(event) {
                ...
                Swal.fire({
                    title: '⚙️ ¿Editar este registro?',
                    text: 'Estás a punto de modificar los datos de esta captura. ¿Deseas continuar?',
                    icon: 'question',
